...
?>
 ...
 <div class="form-page justify-content-center">
    ...
    <div class="form-body">
       ...
       <div class="register-form"> 
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="form <?php echo (!empty($telephone_err)) ? 'has-error' : ''; ?>">                   
                ...
                <div class="form <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">                   
                    ...
                    <label for="confirm-password" class="label-name">
                ...
                <input type="submit" class="form-submit" name="reg_user" value="Submit"> 
